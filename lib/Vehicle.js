felony.Vehicle = felony.Body.extend({
	...
	initialize: function () {
		...
		jointDef.Initialize(this.body, this.wheelRearLeft, this.wheelRearLeft.GetWorldCenter());
		felony.game.world.CreateJoint(jointDef);
		
		jointDef.Initialize(this.body, this.wheelRearRight, this.wheelRearRight.GetWorldCenter());
		felony.game.world.CreateJoint(jointDef);
